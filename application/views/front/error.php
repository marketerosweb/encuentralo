...
<head>
    ...
    <title>404 no se encontró |<?php echo $system_title; ?></title>
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="error-v4">
                   <a href="<?php echo base_url(); ?>"><img src="<?php echo $this->crud_model->logo('home_top_logo'); ?>" alt=""></a>
                    <h1>404</h1>
                    <span class="sorry">Lo sentimos! la página que estabas buscando no se encontro</span>
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <a class="btn-u btn-brd btn-brd-hover rounded btn-u-vio btn-u-md" href="<?php echo base_url(); ?>index.php/home/"> Volver al centro comercial virtual</a>
                        </div> 
                        <div class="col-md-6 col-md-offset-3">
                        <p class="list-unstyled link-list" style="margin-top:60px;">2016 &copy; Todos los derechos reservados @ <a target="_blank" style="color:#000;" href="<?php echo base_url(); ?>">EncuentraloPronto</a></p>
                        </div>
                    </div>
                </div>
            </div>
