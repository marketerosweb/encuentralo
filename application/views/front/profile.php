                	...
                	<div class="row margin-bottom-30">
                        ...
                        <div class="col-sm-6">
                            <div class="service-block-v3 service-block-blue">
                                ...
                                <span class="service-heading">Productos favoritos</span>
                                <span class="counter">
                    ...
                    <div class="tab-v2">
                        <ul class="nav nav-tabs">
                           ...
                           <!-- <li class=""><a href="#downloads" data-toggle="tab"><?php echo translate('downloads');?></a></li>-->
                            <li class=""><a href="#wishli" data-toggle="tab">Lista de favoritos</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <?php
												echo '<form method="post">
													<input type="hidden" value="siproducto">
														<input type="submit" value="Si">
														</form>';
													echo '<form method="post">
														<input type="hidden" value="noproducto">
