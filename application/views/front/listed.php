            ...
            <div class="overflow-h margin-bottom-5">
                <div class="col-sm-12">
                    <div class="col-sm-6 pull-left">
                        ...
                        <div class="margin-bottom-10">
                            <span class="gender">
                                <?php echo 'Tienda'.' : '.$this->crud_model->product_by($row['product_id'],'with_link'); ?>
                            </span>
                        </div>
						<?php
                            }
                    ...
                    <div class="col-sm-6">
                        ...
                        <ul class="list-inline margin-bottom-20">
                            ...
                            <li class="pull-right">
                                <a class="btn-u btn-u-cust float-shadow various fancybox.ajax" data-fancybox-type="ajax" href="<?php echo $this->crud_model->product_link($row['product_id'],'quick'); ?>" style="padding:2px 13px !important;">Vista Rápida</a>
                            </li>
                        </ul>
                     </div>
                 </div>
