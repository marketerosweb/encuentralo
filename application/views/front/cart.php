        ...
        <div class="container">
            ...
            ?>    
                <div>
                                ...
                                <thead>
                                    <tr>
                                       ...
                                       <!-- <td>Precio</td>-->
                                        <td>Cantidad</td>
                                        <td>total</td>
                                        <td style="text-align:right !important;">Borrar</td>
                                    </tr>
                                </thead>
                                <tbody>
                    ...
                    <script>
                        var add_to_cart = '<?php echo 'Agregar a la bolsa'; ?>';
                    ...
                    <div class="header-tags">
                        <div class="overflow-h">
                            ...
                            <p>Valor de envío y dirección </p>
                        ...
                        <div class="row">
                            <div class="col-md-12 md-margin-bottom-40">
                                ...
                                <div class="billing-info-inputs checkbox-list">
                                    ...
                                    <input id="address_2"  type="text" placeholder="<?php echo translate('address_line_2'); ?>" name="address2" class="form-control address">
                                    <div class="row">
                                        <div class="col-sm-6">
                    ...
                    <section>
                        <div class="row">
                            <div class="col-md-6 md-margin-bottom-50">
                                <h2 class="title-type">Escoge tu método de pago</h2>
                            ...
                            <div class="col-sm-4 sm-margin-bottom-30">
                                ...
                                <span id="coupon_report">
                                    <?php if($this->cart->total_discount() <= 0 && $this->session->userdata('couponer') !== 'done' && $this->cart->get_coupon() == 0){ ?>
                                        ...
                                        <button type="button" class="btn-u btn-u-sea-shop coupon_btn">Aplicar cupón</button>
                                    <?php } else { ?>
                                ...
                                $('.coupon_btn').on('click',function(){
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(result){
                                            if(result == 'nope'){
                                                notify("Código no válido",'warning','bottom','right');
                                            } else {
                                                var re = result.split(':-:-:');
                                                var ty = re[0];
                                                var ts = re[1];
                                                $("#coupon_report").fadeOut();
                                                notify("Cupón válido",'success','bottom','right');
                                                if(ty == 'total'){
                                                    $(".coupon_disp").show();
                                                    $("#disco").html(re[2]);
                                                }
