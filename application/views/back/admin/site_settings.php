            ...
            <div class="tab-base tab-stacked-left">
                <ul class="nav nav-tabs">
                   ...
                   <!-- <li>
                    ...
                    <li >
                        <a data-toggle="tab" href="#demo-stk-lft-tab-4">Redes sociales</a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-7">Configurar inicio de sesión con redes sociales</a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-c">Configuración de comentarios</a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-8">Ajustes del captcha</a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-6">Términos y condiciones</a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-p">Política de privacidad</a>
                    </li>
                  <!--  <li>
                        ...
                        <div class="panel">
                            ...
                            ?>
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" ><?php echo translate('homepage_cache_time');?> (minutos)</label>
                                        <div class="col-sm-4">
